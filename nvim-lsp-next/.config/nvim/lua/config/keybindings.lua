...
vimp.nnoremap('<C-l>a', vim.lsp.buf.code_action)
vimp.nnoremap('<C-l>R', vim.lsp.buf.references)
vimp.nnoremap('<C-l>e', vim.lsp.diagnostic.show_line_diagnostics)
vimp.nnoremap('<C-l>p', vim.lsp.diagnostic.goto_prev)
vimp.nnoremap('<C-l>n', vim.lsp.diagnostic.goto_next)
...
vimp.nnoremap('<C-d>t', dapui.toggle)

vimp.nnoremap('<C-d>c', dap.continue)
vimp.nnoremap('<C-d>s', dap.step_over)
vimp.nnoremap('<C-d>i', dap.step_into)
vimp.nnoremap('<C-d>o', dap.step_out)

vimp.nnoremap('<C-d>b', dap.toggle_breakpoint)
vimp.nnoremap('<C-d>B', function () dap.set_breakpoint(vim.fn.input('Breakpoint condition: ')) end)
vimp.nnoremap('<C-d>l', function () dap.set_breakpoint(nil, nil, vim.fn.input('Log point message: ')) end)
vimp.nnoremap('<C-d>r', dap.repl.open)
vimp.nnoremap('<C-d>p', dap.run_last)
